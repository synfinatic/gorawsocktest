...
func (i *IPv4) LayerType() gopacket.LayerType { return layers.LayerTypeIPv4 }
func (i *IPv4) NetworkFlow() gopacket.Flow {
	return gopacket.NewFlow(layers.EndpointIPv4, i.SrcIP, i.DstIP)
}
...
func (ip *IPv4) DecodeFromBytes(data []byte, df gopacket.DecodeFeedback) error {
	...
	ip.BaseLayer = layers.BaseLayer{Contents: data}
